    ...
    <KeyboardAvoidingView behavior="height">
      ...
      <View style={styles.container}>
        <Text style={styles.title}>
          {isUser ? "Log In page" : "Sign Up page"}
        </Text>
        <TextInput
          value={email}
          style={styles.input}
        ...
        {loading ? (
          ...
          <>
            {isUser ? (
              <Text style={styles.button} onPress={() => signIn()}>
                Login
              </Text>
            ) : (
              <Text style={styles.button} onPress={() => signUp()}>
                Create account
              </Text>
            )}
            {isUser ? (
              <Text style={styles.subText} onPress={() => changeIsUserState()}>
