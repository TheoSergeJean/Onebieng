...
const Nutrition = ({ navigation }) => {
  ...
  useEffect(() => {
    fetch(
      "https://api.spoonacular.com/food/ingredients/search?query=" +
        product +
        "&number=30&sort=calories&sortDirection=desc",
      {
  ...
  function dailyCaloricNeeds(age, height, weight, gender, activityLevel) {
    ...
    if (gender === "male") {
      ...
      caloricNeeds = 447.593 + 9.247 * weight + 3.098 * height - 4.33 * age;
    }
  ...
  return (
    <ScrollView>
      ...
      >
        ...
        <Text>
          Your macros needs :
          {dailyCaloricNeeds(age, height, weight, sex, activityLevel)} cal
        </Text>
      </View>
